...
export default function AdminLoginPage() {
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-6 py-16" data-testid="admin-login-page">
      <form onSubmit={submit} className="w-full max-w-md bg-white border border-[#701A3D]/10 p-10">
        ...
        <h1 className="font-serif text-3xl text-[#701A3D] text-center mb-8">Óptica Ari</h1>
