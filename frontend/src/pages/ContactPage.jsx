...
export default function ContactPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-16 py-16 md:py-24" data-testid="contact-page">
      ...
      <h1 className="font-serif text-5xl md:text-6xl text-[#701A3D] gold-rule mb-16">Hablemos</h1>
          ...
          <ul className="space-y-6">
            <li className="flex gap-4" data-testid="contact-phone">
              ...
              <div>
                ...
                <a href={waLink("Hola Óptica Ari")} target="_blank" rel="noreferrer" className="font-serif text-2xl text-[#701A3D] hover:text-[#E6007E]">999 902 2780</a>
              </div>
            </li>
            <li className="flex gap-4">
              ...
              <div>
                ...
                <div className="font-serif text-xl text-[#701A3D]">contacto@opticaari.mx</div>
              </div>
            </li>
            <li className="flex gap-4">
              ...
              <div>
                ...
                <div className="font-serif text-xl text-[#701A3D]">Kanasín, Yucatán, México</div>
              </div>
            </li>
            <li className="flex gap-4">
              ...
              <div>
                ...
                <div className="text-[#701A3D]">Lun – Vie · 9:30 – 19:30</div>
                <div className="text-[#701A3D]">Sáb · 10:00 – 17:00</div>
              </div>
            </li>
          </ul>
        </div>

        <form onSubmit={submit} className="bg-white border border-[#701A3D]/10 p-8 space-y-5" data-testid="contact-form">
          <div>
            <label className="eyebrow block mb-2">Nombre</label>
            <input
              required value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })}
              className="w-full border border-[#701A3D]/20 px-4 py-3 focus:border-[#C5A059] focus:outline-none"
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full border border-[#701A3D]/20 px-4 py-3 focus:border-[#C5A059] focus:outline-none resize-none"
